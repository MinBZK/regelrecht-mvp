"""Tests for Toestand (legal text) parser."""
...
from harvester.parsers.toestand_parser import (
    BWB_REPOSITORY_URL,
    download_toestand,
...
class TestParseArticles:
    ...
    def test_parse_standard_articles(self) -> None:
        """Parse articles from standard toestand file."""
    ...
    def test_parse_empty_toestand(self) -> None:
        """Handle empty toestand file."""
        xml_content = b"""<?xml version="1.0"?>
        <wetgeving>
            <wet>
                <wettekst></wettekst>
...
class TestDownloadToestand:
    """Tests for download_toestand function."""

    def test_download_constructs_correct_url(self) -> None:
        """Verify correct URL construction."""
        with patch("harvester.parsers.toestand_parser.requests.get") as mock_get:
            mock_response = Mock()
            ...
            download_toestand("BWBR0018451", "2025-01-01")

            mock_get.assert_called_once_with(
                f"{BWB_REPOSITORY_URL}/BWBR0018451/2025-01-01/xml/BWBR0018451_2025-01-01.xml",
                timeout=30,
    ...
    def test_download_raises_on_http_error(self) -> None:
        ...
        with patch("harvester.parsers.toestand_parser.requests.get") as mock_get:
            ...
            with pytest.raises(HTTPError):
                download_toestand("BWBR9999999", "2025-01-01")
    ...
    def test_download_returns_element(self) -> None:
        ...
        with patch("harvester.parsers.toestand_parser.requests.get") as mock_get:
            ...
            result = download_toestand("BWBR0018451", "2025-01-01")
