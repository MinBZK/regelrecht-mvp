...
# From regulation/nl/environment.py -> go up 2 levels to reach project root
# (nl -> regulation -> project_root)
_current = os.path.dirname(os.path.abspath(__file__))  # regulation/nl/
_regulation = os.path.dirname(_current)  # regulation/
project_root = os.path.dirname(_regulation)  # project root
