...
| 2 | Awb, Mediawet | Dubbele leden bij gefaseerde inwerkingtreding | open | - |
...
| 6 | AOW | Vervallen artikelen krijgen leeg nummer | open | - |
...
2. **Issue #2** (Gefaseerde inwerkingtreding) - Raakt 2 wetten, structureel probleem
3. **Issue #6** (Lege nummers vervallen artikelen) - Eenvoudige fix
