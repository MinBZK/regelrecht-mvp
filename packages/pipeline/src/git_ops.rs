...
mod tests {
    ...
    /// Helper: create a clone of the bare remote.
    ...
    async fn test_commit_nothing_returns_false() {
        ...
        // Nothing staged — commit should return false
    ...
    async fn test_push_disabled_is_noop() {
        ...
        // Push with enabled=false should not fail even without commits
