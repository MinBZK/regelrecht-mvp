//! Integration tests for git_ops module.
//!
//! These tests use real git operations with local bare repos.
//! They do NOT require network access or Docker.
...
async fn test_push_disabled_is_noop() {
    ...
    // push(false) should succeed silently
...
async fn test_add_nested_paths() {
    ...
    // Create nested directory structure like regulation/nl/wet/slug/
